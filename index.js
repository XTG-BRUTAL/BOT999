...
const reply = (teks) => {
			itsmevall.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `isko gulambi chaiye XD`,body:"",previewType:"PHOTO",thumbnail:bgg,sourceUrl:`https://wa.me/919101765679?text=Hello bro`}}})
		}
    ...
    const ftroli = {
      key: {
        ...
        remoteJid: "919101765679-1604595598@g.us",
      },
      message: {
        orderMessage: {
          itemCount: 10,
...
const finv = {
	...
	"message": {
		"groupInviteMessage": {
			"groupJid": "919101765679-1616169743@g.us",
...
const fview = {
    ...
    const fvn = {
      key: {
        participant: `0@s.whatsapp.net`,
        ...(from ? { remoteJid: "919101765679-1613049930@g.us" } : {}),
      },
      message: {
        audioMessage: {
...
"key": {
	  "participant": `0@s.whatsapp.net`,
      "remoteJid": "919101765679-1613049930@g.us",
      "fromMe": false,
      ...
      itsmevall.sendMessage(from, teks, text, {
        quoted: {
          key: {
            fromMe: false,
            participant: `0@s.whatsapp.net`,
            ...(from ? { remoteJid: "919101765679-1604595598@g.us" } : {}),
          },
          message: {
            imageMessage: {
              url: "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc",
...
itsmevall.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    const add = function (from, orangnya) {
      itsmevall.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	grup = itsmevall.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '919101765679-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/FpE1TXXUzuk0TASzYwX8ZM', "groupName": `Brutal-Bot Inc.`, "footerText": "*_© Brutal_*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
...
sendEphemeral: false,
"externalAdReply": {
                "title": `Vimdhayak Bot\nX e o n. (@josephBrutal) •Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
...
Instagram = https://www.instagram.com/fakebrutal_/
Github = https://github.com/XTG-BRUTAL/BOT999
...
break
      /*case "owner":
        sendKontak(from, owner, "Brutal", "Busy");*/
case 'owner':
           case 'creator':
...
break;
      ...
      //------------------< Group Features >-------------------
      case "listonline": //code by Brutal
...
case 'ytgw':
  reply('https://www.youtube.com/c/XTGBRUTAL')
					break;
   case 'ss':
      reply(mess.wait)
...
case "asupan3": // by Brutal
  ...
  case 'write': case 'writeabook':            
            if (args.length == 0) return reply(`contoh: ${prefix + command} Brutal`)
            reply(mess.wait)
            teks = args.join(" ")
...
itsmevall.sendMessage(from, stdout, text, term)
      ...
      default:
		if (hour_now >= '02:00' && hour_now <= '04:00') {
          console.log(color('[Bot Message]', 'cyan'), color('Subscribe Brutal', 'yellow'), color('(😊)', 'white'))
          }
        ...
        if (hour_now >= '06:00' && hour_now <= '11:00') {
          console.log(color('[Bot Message]', 'cyan'), color('Susbcribe Brutal', 'yellow'), color('(😅)', 'white'))
          }
...
if (budy.includes(`emotional`)) {
Brutal Peli = fs.readFileSync('./voicesticker/emotional.webp');
itsmevall.sendMessage(from, Peli, MessageType.sticker, {quoted: mek})
}
    ...
    e = String(e);// fixed fromMe by Brutal
